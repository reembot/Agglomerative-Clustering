...
echo Remember to close dendrogram window for program to continue...
    python3 hierarchicalclustering.py test test_01.csv sin >sintest1_output.txt; sync
    
echo Testing dataset test_1 with Average Linkage for data points close together:
echo Remember to close dendrogram window for program to continue...
    python3 hierarchicalclustering.py test test_01.csv avg >avgtest1_output.txt; sync
    
echo Testing dataset test_1 with Complete Linkage for data points close together:
echo Remember to close dendrogram window for program to continue...
    python3 hierarchicalclustering.py test test_01.csv com >comtest1_output.txt; sync
